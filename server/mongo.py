...
if __name__ == '__main__':
    ...
    customer.insert({'nickName': 'son', '_id': '3', 'psw': 'test1234', 'sex': False, 'age': 0, 'friend':['1_default']})
    customer.insert({'nickName': 'mother', '_id': '2', 'psw': 'test1234', 'sex': False, 'age': 0, 'friend':['1_default']})
    customer.insert({'nickName': 'father', '_id': '1', 'psw': 'test1234', 'sex': True, 'age': 0, 'friend':[]})
